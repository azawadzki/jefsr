...
public class FSStandard extends FSFixture {
	...
	private byte[] userKeyBytes = { 67, 19, 65, -122, 0, 64, -118, -98, -111,
			-125, -26, -91, 105, 21, -67, 115, 14, 109, -78, -57, 31, 120, 117,
			109, 77, 54, -123, -61, -31, 6, -116, 4, -15, 13, -25, -111, 97,
			122, 10, -118, };
	private byte[] volumeKeyBytes = { -10, -49, 73, 90, 91, 117, -79, 61, -108,
			-18, -16, 127, 102, -113, 93, -51, 105, 37, -26, -119, 104, 44, 17,
			84, 57, 100, 11, -67, 92, -105, -117, -65, 30, -58, -68, -92, 64,
			-37, -54, 56 };
	...
	public List<CoderFixture> getBlockTestVectors()
			throws CipherConfigException {
		Key k1 = getVolumeKey();
		final byte[] i1 = { 78, 69, -36, -2, -48, 96, 34, -94, 80, -14, 33,
				-57, 35, -48, -119, 9 };
		long iv = 43564;
		byte[] o1 = { 76, 101, 110, 110, 97, 46, 112, 110, 103, 7, 7, 7, 7, 7,
				7, 7 };
		List<CoderFixture> r = new ArrayList<CoderFixture>();
		r.add(new CoderFixture(k1, i1, iv, o1));
		return r;
